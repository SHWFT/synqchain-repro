...
{
  const handler =
    {} as typeof import('../../app/(app)/connector-playground/page.js');
...
{
  const handler =
    {} as typeof import('../../app/(app)/supplier-portal/page.js');
...
{
  const handler =
    {} as typeof import('../../app/api/erps/mock/[resource]/route.js');
